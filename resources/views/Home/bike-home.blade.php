  ...
  <div class="">
      <div class="container p-5">
          <div class="row align-items-center">
              <div class="col-md-6">
                  <h1 class="fw-bold my-black">Best & Largest Bike Dealer In <span class="my-text">Your City</span></h1>
                  <p>
                  </p>
                  <button class="btn my-bg text-white">Get Quote Now</button>
              </div>
              <div class="col-md-6">
                  <img src="{{url('/public/dimages/XtrYCmjb2022-Kawasaki-Ninja-ZX-6R2-1536x1152-1.jpg')}}" class="img-fluid" alt="">
              </div>
          </div>
      </div>
  </div>
