                            ...
                            @foreach ($data as $item)
                                <tr>
                                    <td>
                                        ...
                                        <a href="{{url('/dashboard/vehicle-delete')}}/{{$item->vehicle_id}}" class="btn btn-danger ms-2"><svg xmlns="http://www.w3.org/2000/svg" width="18"
                                    ...
                                    <td><img src="{{url('/public/dimages')}}/{{$item->vehicle_img}}" alt="" width="60px"></td>
                                    ...
                                    <td >
                                    <p style="width:100px;height:100px;overflow:auto;">
                                        {{$item->vehicle_short_desc}}
                                    </p>
                                    </td>
                                    <td >
                                        <p style="width:140px;height:100px;overflow:auto;">
                                        {{$item->vehicle_long_desc}}
                                        </p>
                                    </td>
